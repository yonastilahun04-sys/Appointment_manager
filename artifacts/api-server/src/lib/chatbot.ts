...
const EN: Strings = {
  ...
  askPhone: "Got it. Can I have your phone number? Please use the same number in English and Amharic.",
...
const AM: Strings = {
  ...
  askPhone: "እሺ። ስልክ ቁጥርዎን እባክዎ። በእንግሊዝኛና በአማርኛ አንድ ዓይነት ቁጥር ይጠቀሙ።",
